...
CREATE TABLE `Address` (
  ...
  UNIQUE KEY `cn_Address_Unique` (`Address1`,`Address2`,`Address3`,`Zip`)
...
CREATE TABLE `Person` (
  ...
  UNIQUE KEY `cn_Person_Unique` (`User_EmailAddress`,`PersonType_idPersonType`),
  ...
  CONSTRAINT `fk_Person_Address` FOREIGN KEY (`Address_idAddress`) REFERENCES `Address` (`idAddress`),
...
INSERT INTO `PersonType` VALUES (4,'Investor'),(1,'Owner'),(6,'Owner/PropertyManager'),(3,'PropertyManager'),(5,'ServiceProvider'),(2,'Tenant');
...
-- Dump completed on 2020-07-04 15:35:14
